...
import com.stepasha.buildinglocator.handlers.RestExceptionHandler;
...
public class UserController
{
    ...
    // http://localhost:2222/users/users/?page=1&size=1
    // http://localhost:2222/users/users/?sort=username,desc&sort=<field>,asc
    // http://localhost:2222/users/users
    ...
    // http://localhost:2222/users/user/name/like/da?sort=username
    ...
    // http://localhost:2222/users/user
    /*
            {
                "username": "Mojo",
...
*/
    ...
    // http://localhost:2222/users/user/7/role/2
    ...
    // http://localhost:2222/users/user/15/role/2
    ...
    // http://localhost:2222/users/user/email/count
