package com.stepasha.buildinglocator.logging;
...
//TODO 7.1 LoggingAspect targets the project to log (need LogWriterClass)

@Component
@Aspect
public class LoggingAspect
{
    @Around(value = "@within(com.stepasha.buildinglocator.logging.Loggable) || @annotation(com.stepasha.buildinglocator.logging.Loggable)")
